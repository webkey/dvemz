				...
				<div class="nav-wrap__cell">
					<header class="nav-title">
						<a href="index.html" class="logo-nav">
							<div class="logo-nav__img"><span>ДВЭМЗ</span></div>
							<span class="logo-nav__title">Электрощитовое оборудование</span>
						</a>
					</header>
				</div>
			</div>
			...
			<div class="nav-wrap__row">
				<div class="nav-wrap__cell">
					<footer class="nav-footer">
						<a href="#" class="btn-siblings"><i>&nbsp;</i><span>Электроавтоматика</span></a>
